...
export default function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-3 z-[68] inline-flex h-11 w-11 items-center justify-center rounded-full bg-green-500 p-0 text-xs font-bold text-white shadow-[0_16px_38px_-12px_rgba(34,197,94,.65)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:bg-green-600 hover:shadow-xl active:scale-[.98] sm:bottom-6 sm:right-6 sm:h-auto sm:w-auto sm:min-h-12 sm:gap-2 sm:px-4 sm:py-3"
    >
