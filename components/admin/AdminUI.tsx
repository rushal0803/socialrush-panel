...
export function AdminStatus({ value }: { value: string }) {
  const styles: Record<string, string> = { active: "bg-emerald-50 text-emerald-700", admin: "bg-violet-50 text-violet-700", blocked: "bg-rose-50 text-rose-700", inactive: "bg-slate-100 text-slate-600", pending: "bg-amber-50 text-amber-700", processing: "bg-blue-50 text-blue-700", in_progress: "bg-cyan-50 text-cyan-700", completed: "bg-emerald-50 text-emerald-700", paid: "bg-emerald-50 text-emerald-700", partial: "bg-violet-50 text-violet-700", cancelled: "bg-slate-100 text-slate-600", refunded: "bg-indigo-50 text-indigo-700", failed: "bg-rose-50 text-rose-700", refill_requested: "bg-orange-50 text-orange-700", refilling: "bg-sky-50 text-sky-700", open: "bg-blue-50 text-blue-700", answered: "bg-emerald-50 text-emerald-700", solved: "bg-emerald-50 text-emerald-700", closed: "bg-slate-100 text-slate-600" };
  return (
