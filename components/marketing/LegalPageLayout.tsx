    ...
    <div className="relative overflow-x-clip bg-[radial-gradient(circle_at_18%_18%,rgba(255, 159, 0, .16),transparent_38%),radial-gradient(circle_at_84%_12%,rgba(255, 122, 0, .17),transparent_42%),radial-gradient(circle_at_52%_84%,rgba(255, 159, 0, .15),transparent_45%)] pb-20 pt-8 sm:pb-24 lg:pt-10">
      <div className="pointer-events-none absolute inset-0">
        <motion.div
          ...
          className="absolute -left-16 top-10 h-72 w-72 rounded-full bg-orange-200/35 blur-3xl"
        />
        <motion.div
          aria-hidden
          animate={{ y: [0, 10, 0], x: [0, -8, 0] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
          className="absolute right-[-5rem] top-16 h-80 w-80 rounded-full bg-amber-200/40 blur-3xl"
        />
        <motion.div
          aria-hidden
          animate={{ y: [0, -8, 0] }}
          transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-10 left-1/3 h-64 w-64 rounded-full bg-amber-200/35 blur-3xl"
        />
      </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-start">
              ...
              >
                <p className="text-[10px] font-black uppercase tracking-[0.15em] text-[#111827]">Legal confidence</p>
                <p className="mt-3 text-lg font-black text-[#0B0B0F]">Trusted, readable policy experience</p>
                <div className="mt-4 space-y-3 text-xs text-[#111827]">
                  <p className="rounded-xl border border-[#FFF8F1] bg-white/80 px-3 py-2">Effective from June 2026</p>
              <p className="rounded-xl border border-[#FFF8F1] bg-white/80 px-3 py-2">Support: support@getsocialrush.com</p>
                  <p className="rounded-xl border border-[#FFF8F1] bg-white/80 px-3 py-2">Designed for clarity and compliance</p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              {trustCards.map((card, index) => (
                ...
                >
                  <p className="text-xs font-black text-[#0B0B0F]">{card.title}</p>
