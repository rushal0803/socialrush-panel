  ...
  return (
    <PublicShell tone="default">
      ...
      <InteractiveHomepageShell><div className="service-money-page bg-[#07090d] px-4 pb-20 pt-8 text-white sm:px-6 lg:px-8"><div className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 rounded-3xl border border-orange-400/20 bg-gradient-to-r from-orange-500/10 to-amber-400/5 p-6 text-center sm:p-8"><h2 className="text-2xl font-black">Ready to place your {headline} order?</h2><p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-zinc-300">Review the current order details and continue through the SocialRUSH checkout.</p><Link href={orderHref} className="mt-5 inline-flex min-h-12 items-center justify-center rounded-2xl bg-gradient-to-r from-orange-500 to-amber-400 px-7 py-3 text-sm font-black text-black">Start Order</Link></section>
