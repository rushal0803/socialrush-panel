  ...
  return (
    <PublicShell tone="default">
      ...
      <InteractiveHomepageShell><div className="service-money-page bg-[#07090d] px-4 pb-20 pt-8 text-white sm:px-6 lg:px-8"><div className="mx-auto max-w-7xl">
        ...
        <aside className="rounded-3xl border border-white/10 bg-black/25 p-5 backdrop-blur sm:p-6"><p className="text-xs font-black uppercase tracking-[.15em] text-orange-300">Service snapshot</p><div className="mt-5 grid grid-cols-2 gap-3"><div className="rounded-2xl border border-white/10 bg-white/[.035] p-4"><p className="text-xs text-zinc-500">Rate</p><p className="mt-2 text-lg font-black"><CurrencyAmount amountINR={service.pricePer1000} suffix=" / 1K" /></p></div><div className="rounded-2xl border border-white/10 bg-white/[.035] p-4"><p className="text-xs text-zinc-500">Delivery</p><p className="mt-2 text-sm font-black">{deliveryDisplay}</p></div><div className="rounded-2xl border border-white/10 bg-white/[.035] p-4"><p className="text-xs text-zinc-500">Minimum</p><p className="mt-2 text-sm font-black">{service.minQuantity.toLocaleString("en-IN")}</p></div><div className="rounded-2xl border border-white/10 bg-white/[.035] p-4"><p className="text-xs text-zinc-500">Refill</p><p className="mt-2 text-sm font-black">{service.refillPolicy}</p></div></div></aside></div></section>
