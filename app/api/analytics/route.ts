...
const safeKeys = new Set(["step", "payment_path", "link_type", "validation_passed", "error_category", "technical_reference", "currency", "method", "reorder", "metric", "value", "rating", "surface"]);
