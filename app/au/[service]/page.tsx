...
export function generateMetadata({ params }: { params: { service: string } }) { const page = getPublishedCountryServicePage("au", params.service); return page ? createCountryServiceMetadata(page) : {}; }
export default function Page({ params }: { params: { service: string } }) { const page = getPublishedCountryServicePage("au", params.service); if (!page) notFound(); return <CountryServiceLandingPage page={page} />; }
