...
const sections = [
  ...
  { title: "How to request review", body: ["Open a support ticket or email support@getsocialrush.com with the account email, payment or order ID, reason, and relevant evidence. Prompt requests are easier to investigate."] },
