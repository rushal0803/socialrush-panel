...
export const metadata = createCatalogServiceMetadata("twitter-crypto-custom-comments");

export default function Page() {
  return <PremiumCatalogServiceLanding serviceCode="twitter-crypto-custom-comments" />;
}
