...
export function generateMetadata({ params }: { params: { service: string } }) { const page = getPublishedCountryServicePage("ca", params.service); return page ? createCountryServiceMetadata(page) : {}; }
export default function Page({ params }: { params: { service: string } }) { const page = getPublishedCountryServicePage("ca", params.service); if (!page) notFound(); return <CountryServiceLandingPage page={page} />; }
