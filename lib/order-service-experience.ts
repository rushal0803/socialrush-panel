...
export const serviceExperience: Record<string, { name: string; outcome: string; required: string }> = {
  ...
  "linkedin-usa-connections": { name: "LinkedIn USA Connections", outcome: "USA-targeted connection activity for a selected public personal profile.", required: "Public LinkedIn personal profile link" },
  "linkedin-usa-post-likes": { name: "LinkedIn USA Post Likes", outcome: "USA-targeted like activity for a selected public post.", required: "Public LinkedIn post link" },
  "linkedin-usa-endorsements": { name: "LinkedIn USA Endorsements", outcome: "USA-targeted endorsement activity for a specified profile skill.", required: "Public LinkedIn personal profile link and skill name" },
  "linkedin-usa-followers": { name: "LinkedIn USA Followers", outcome: "USA-targeted follower activity for a selected public personal profile.", required: "Public LinkedIn personal profile link" },
  "linkedin-usa-group-members": { name: "LinkedIn USA Group Members", outcome: "USA-targeted member activity for a selected LinkedIn Group.", required: "LinkedIn Group link" },
  "linkedin-usa-custom-comments": { name: "LinkedIn USA Custom Comments", outcome: "Customer-provided USA-targeted comments on a selected public post.", required: "Public LinkedIn post link and comments" },
  "linkedin-usa-reposts": { name: "LinkedIn USA Reposts", outcome: "USA-targeted repost activity for a selected public post.", required: "Public LinkedIn post link" },
  ...
  "tiktok-custom-comments": { name: "TikTok Custom Comments", outcome: "Customer-provided comment activity on a selected TikTok video.", required: "Public TikTok video link and comments" },
  "tiktok-story-views": { name: "TikTok Story Views", outcome: "Viewing activity on an eligible TikTok target.", required: "Eligible TikTok target link" },
  "tiktok-saves": { name: "TikTok Saves", outcome: "Save activity on a selected TikTok video.", required: "Public TikTok video link" },
...
export const linkRules: Record<string, LinkRule> = {
  ...
  "linkedin-usa-connections": { label: "LinkedIn personal profile URL", placeholder: "https://linkedin.com/in/your-profile", helper: "Enter the correct public LinkedIn personal profile URL and keep the profile accessible while the order is processing.", hosts: ["linkedin.com"], pathHint: /^\/in\/[^/]+\/?$/i, error: "Enter a valid LinkedIn personal profile URL (linkedin.com/in/...)." },
  "linkedin-usa-post-likes": { label: "LinkedIn post URL", placeholder: "https://linkedin.com/posts/...", helper: "Enter the exact public LinkedIn post URL and keep the post accessible while the order is processing.", hosts: ["linkedin.com"], pathHint: /^\/(posts\/[^/]+|feed\/update\/[^/]+)\/?$/i, error: "Enter a valid public LinkedIn post URL." },
  "linkedin-usa-endorsements": { label: "LinkedIn personal profile URL", placeholder: "https://linkedin.com/in/your-profile", helper: "Enter the correct public LinkedIn personal profile URL and specify the exact skill that should receive endorsements.", hosts: ["linkedin.com"], pathHint: /^\/in\/[^/]+\/?$/i, error: "Enter a valid LinkedIn personal profile URL (linkedin.com/in/...)." },
  "linkedin-usa-followers": { label: "LinkedIn personal profile URL", placeholder: "https://linkedin.com/in/your-profile", helper: "Enter the correct public LinkedIn personal profile URL and keep the profile accessible while the order is processing.", hosts: ["linkedin.com"], pathHint: /^\/in\/[^/]+\/?$/i, error: "Enter a valid LinkedIn personal profile URL (linkedin.com/in/...)." },
  "linkedin-usa-group-members": { label: "LinkedIn Group URL", placeholder: "https://linkedin.com/groups/...", helper: "Enter the correct LinkedIn Group URL and keep the group accessible as required while the order is processing.", hosts: ["linkedin.com"], pathHint: /^\/groups\/[^/]+\/?$/i, error: "Enter a valid LinkedIn Group URL (linkedin.com/groups/...)." },
  "linkedin-usa-custom-comments": { label: "LinkedIn post URL", placeholder: "https://linkedin.com/posts/...", helper: "Enter the exact public LinkedIn post URL and provide exactly one custom comment per line. The number of valid comments must match the order quantity.", hosts: ["linkedin.com"], pathHint: /^\/(posts\/[^/]+|feed\/update\/[^/]+)\/?$/i, error: "Enter a valid public LinkedIn post URL." },
  "linkedin-usa-reposts": { label: "LinkedIn post URL", placeholder: "https://linkedin.com/posts/...", helper: "Enter the exact public LinkedIn post URL and keep the post accessible while the order is processing.", hosts: ["linkedin.com"], pathHint: /^\/(posts\/[^/]+|feed\/update\/[^/]+)\/?$/i, error: "Enter a valid public LinkedIn post URL." },
  ...
  "tiktok-followers": { label: "TikTok profile link", placeholder: "https://www.tiktok.com/@yourprofile", helper: "Enter the correct public TikTok profile URL and keep the profile publicly accessible while the order is processing.", hosts: ["tiktok.com"], pathHint: /^\/@[^/]+\/?$/i, error: "Enter a valid public TikTok profile link." },
  "tiktok-likes": { label: "TikTok video link", placeholder: "https://www.tiktok.com/@username/video/...", helper: "Enter the correct public TikTok video URL and keep the video publicly accessible while the order is processing.", hosts: ["tiktok.com"], pathHint: /^\/@[^/]+\/video\/\d+\/?$/i, error: "Enter a valid public TikTok video link." },
  "tiktok-views": { label: "TikTok video link", placeholder: "https://www.tiktok.com/@username/video/...", helper: "Enter the correct public TikTok video URL and keep the video publicly accessible while the order is processing.", hosts: ["tiktok.com"], pathHint: /^\/@[^/]+\/video\/\d+\/?$/i, error: "Enter a valid public TikTok video link." },
  "tiktok-custom-comments": { label: "TikTok video link", placeholder: "https://www.tiktok.com/@username/video/...", helper: "Enter the correct public TikTok video URL and provide exactly one custom comment per line. The number of comments must match the order quantity.", hosts: ["tiktok.com"], pathHint: /^\/@[^/]+\/video\/\d+\/?$/i, error: "Enter a valid public TikTok video link." },
  "tiktok-story-views": { label: "TikTok target link", placeholder: "https://www.tiktok.com/@username", helper: "Enter the correct eligible TikTok target URL and keep the target accessible while the order is processing. Structural validation cannot confirm whether a Story is active.", hosts: ["tiktok.com"], pathHint: /^\/@[^/]+(?:\/video\/\d+)?\/?$/i, error: "Enter a valid TikTok target link." },
  "tiktok-saves": { label: "TikTok video link", placeholder: "https://www.tiktok.com/@username/video/...", helper: "Enter the correct public TikTok video URL and keep the video publicly accessible while the order is processing.", hosts: ["tiktok.com"], pathHint: /^\/@[^/]+\/video\/\d+\/?$/i, error: "Enter a valid public TikTok video link." },
