...
export const linkRules: Record<string, LinkRule> = {
  ...
  "telegram-poll-votes": { label: "Telegram poll post link", placeholder: "https://t.me/channelname/123", helper: "Submit the exact public Telegram post containing the poll and keep it accessible while processing.", hosts: ["t.me", "telegram.me"], pathHint: /^\/(?:s\/)?(?!joinchat(?:\/|$)|\+(?:[^/]+$))[^/]+\/\d+\/?$/i, error: "Enter a valid public Telegram poll message link." },
