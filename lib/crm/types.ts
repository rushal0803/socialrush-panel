...
export type CRMLeadCandidate = { id:string; business_name:string; domain:string|null; website_url:string|null; country:string|null; contact_name:string|null; contact_role:string|null; business_email:string|null; email_type:"business"|"role"|"unknown"; email_verification_status:string; source:string; source_name:string|null; research_status:string; qualification_status:string; compliance_status:string; recommended_service:string|null; recommendation_reason:string|null; recommendation_confidence:number; fit_score:number; fit_grade:string; fit_reasons:unknown[]; duplicate_lead_id:string|null; duplicate_kind:string|null; blocked_reason:string|null; promoted_lead_id:string|null; created_at:string };
