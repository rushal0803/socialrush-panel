...
export const contentClusters: Record<ContentPlatform, ContentCluster> = {
  instagram: { platform: "instagram", label: "Instagram", hubPath: "/instagram-growth-india", hubLabel: "Instagram growth hub", serviceLinks: [{ label: "Instagram follower packages", href: "/buy-instagram-followers-india" }, { label: "Instagram likes for public posts", href: "/instagram-likes" }, { label: "Instagram views and Reels support", href: "/instagram-views" }, { label: "Instagram comments in India", href: "/buy-instagram-comments-india" }, { label: "Instagram saves in India", href: "/buy-instagram-saves-india" }, { label: "Instagram shares in India", href: "/buy-instagram-shares-india" }] },
  youtube: { platform: "youtube", label: "YouTube", hubPath: "/youtube-growth-india", hubLabel: "YouTube growth hub", serviceLinks: [{ label: "YouTube subscriber packages", href: "/youtube-subscribers" }, { label: "YouTube views for public videos", href: "/youtube-views" }, { label: "YouTube likes in India", href: "/youtube-likes" }, { label: "YouTube comments in India", href: "/buy-youtube-comments-india" }, { label: "YouTube watch hours", href: "/buy-youtube-watch-hours-india" }] },
  ...
  facebook: { platform: "facebook", label: "Facebook", hubPath: "/facebook-growth-india", hubLabel: "Facebook growth hub", serviceLinks: [{ label: "Facebook follower options in India", href: "/buy-facebook-followers-india" }, { label: "Facebook likes for public posts", href: "/facebook-likes" }, { label: "Facebook views in India", href: "/facebook-views" }, { label: "Facebook shares for public posts", href: "/buy-facebook-shares-india" }, { label: "Facebook group members in India", href: "/buy-facebook-group-members-india" }] },
