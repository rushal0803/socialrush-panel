...
const pages: Record<IndiaServiceSlug, IndiaServicePage> = {
  ...
  "buy-instagram-comments-india": {
    ...
    metaDescription: "Buy Instagram comments in India with fast delivery, transparent pricing, and a simple secure ordering experience from SocialRUSH.",
    ogDescription: "Order Instagram comments in India with transparent INR pricing, public-link ordering, and SocialRUSH dashboard tracking.",
    audiences: ["Creators", "Reel publishers", "Brands", "Social media teams"],
    related: ["buy-instagram-followers-india", "buy-instagram-likes-india", "buy-instagram-views-india", "buy-instagram-saves-india"],
  },
  "buy-instagram-saves-india": {
    ...
    audiences: ["Creators", "Reel publishers", "Brands", "Social media teams"],
    related: ["buy-instagram-followers-india", "buy-instagram-likes-india", "buy-instagram-views-india", "buy-instagram-comments-india"],
  },
  "buy-youtube-subscribers-india": {
