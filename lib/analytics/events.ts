...
export const clientAnalyticsEvents = [
  ...
  "order_started", "order_details_completed", "checkout_started", "payment_started", "utr_submitted", "checkout_error", "checkout_recovery_click",
  ...
  "cross_sell_view", "cross_sell_click", "bundle_view", "bundle_click", "repeat_order_click", "order_success_recommendation_view", "order_success_recommendation_click", "market_hub_viewed",
