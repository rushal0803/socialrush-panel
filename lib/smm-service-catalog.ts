...
export const smmServiceCatalog: SmmService[] = [
  ...
  {
    platform: "linkedin", code: "linkedin-usa-connections", name: "LinkedIn USA Connections",
    description: "Increase connection activity for an eligible public LinkedIn personal profile with the USA-targeted service option.",
    pricePer1000: SERVICE_PRICES["linkedin-usa-connections"], minQuantity: 100, maxQuantity: 10000,
    deliveryTime: "1-3 days", refillPolicy: "No Refill", qualityType: "Professional",
    importantInstruction: "Enter the correct public LinkedIn personal profile URL and keep the profile accessible while the order is processing.", requiresLiveCatalogFacts: true, isActive: true,
  },
  {
    platform: "linkedin", code: "linkedin-usa-post-likes", name: "LinkedIn USA Post Likes",
    description: "Increase visible like activity on an eligible public LinkedIn post with the USA-targeted service option.",
    pricePer1000: SERVICE_PRICES["linkedin-usa-post-likes"], minQuantity: 100, maxQuantity: 10000,
    deliveryTime: "1-3 days", refillPolicy: "30 Days Refill", qualityType: "Professional",
    importantInstruction: "Enter the exact public LinkedIn post URL and keep the post accessible while the order is processing.", requiresLiveCatalogFacts: true, isActive: true,
  },
  {
    platform: "linkedin", code: "linkedin-usa-endorsements", name: "LinkedIn USA Endorsements",
    description: "Increase endorsement activity for a specified skill on an eligible public LinkedIn personal profile with the USA-targeted service option.",
    pricePer1000: SERVICE_PRICES["linkedin-usa-endorsements"], minQuantity: 100, maxQuantity: 10000,
    deliveryTime: "1-3 days", refillPolicy: "No Refill", qualityType: "Professional",
    importantInstruction: "Enter the correct public LinkedIn personal profile URL and specify the exact skill that should receive endorsements.", requiresLiveCatalogFacts: true, isActive: true,
  },
  {
    platform: "linkedin", code: "linkedin-usa-followers", name: "LinkedIn USA Followers",
    description: "Increase follower activity on an eligible public LinkedIn personal profile with the USA-targeted service option.",
    pricePer1000: SERVICE_PRICES["linkedin-usa-followers"], minQuantity: 100, maxQuantity: 10000,
    deliveryTime: "1-3 days", refillPolicy: "30 Days Refill", qualityType: "Professional",
    importantInstruction: "Enter the correct public LinkedIn personal profile URL and keep the profile accessible while the order is processing.", requiresLiveCatalogFacts: true, isActive: true,
  },
  {
    platform: "linkedin", code: "linkedin-usa-group-members", name: "LinkedIn USA Group Members",
    description: "Increase member activity for an eligible LinkedIn Group with the USA-targeted service option.",
    pricePer1000: SERVICE_PRICES["linkedin-usa-group-members"], minQuantity: 100, maxQuantity: 10000,
    deliveryTime: "1-3 days", refillPolicy: "30 Days Refill", qualityType: "Professional",
    importantInstruction: "Enter the correct LinkedIn Group URL and keep the group accessible as required while the order is processing.", requiresLiveCatalogFacts: true, isActive: true,
  },
  {
    platform: "linkedin", code: "linkedin-usa-custom-comments", name: "LinkedIn USA Custom Comments",
    description: "Add customer-provided comment activity to an eligible public LinkedIn post with the USA-targeted service option.",
    pricePer1000: SERVICE_PRICES["linkedin-usa-custom-comments"], minQuantity: 100, maxQuantity: 10000,
    deliveryTime: "1-3 days", refillPolicy: "No Refill", qualityType: "Professional",
    importantInstruction: "Enter the exact public LinkedIn post URL and provide exactly one custom comment per line. The number of valid comments must match the order quantity.", requiresLiveCatalogFacts: true, isActive: true,
  },
  {
    platform: "linkedin", code: "linkedin-usa-reposts", name: "LinkedIn USA Reposts",
    description: "Increase repost activity on an eligible public LinkedIn post with the USA-targeted service option.",
    pricePer1000: SERVICE_PRICES["linkedin-usa-reposts"], minQuantity: 100, maxQuantity: 10000,
    deliveryTime: "1-3 days", refillPolicy: "No Refill", qualityType: "Professional",
    importantInstruction: "Enter the exact public LinkedIn post URL and keep the post accessible while the order is processing.", requiresLiveCatalogFacts: true, isActive: true,
  },
  {
